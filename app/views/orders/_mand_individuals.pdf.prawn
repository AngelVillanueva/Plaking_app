...
pdf.bounding_box([20, pdf.cursor], width: 490, height: 800) do
  pdf.move_down 40
  pdf.font_size 10
  pdf.text "#{tratamiento} #{@order.first_name} #{@order.last_name}, con DNI #{@order.nif}, y domicilio legal en __________________, calle #{@order.address}, en concepto de <b>MANDANTE</b>:", inline_format: true
  pdf.move_down 20
