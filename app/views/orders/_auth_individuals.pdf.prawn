...
pdf.bounding_box([20, pdf.cursor], width: 490, height: 100) do
  pdf.move_down 40
  pdf.font_size 12
  pdf.text "#{tratamiento} #{@order.first_name} #{@order.last_name}, autorizo/a a que 'MATRICULA EL COCHE' retire del Concesionario: #{@order.shop} la documentación original de mi vehículo para proceder a su matriculación."
end
# Signature
pdf.move_down 40
